...
from tests.unit.codescene_reach import pull_request_breaches
from tests.unit.workflow_closure import (
    pull_request_surface,
    refused_references,
)
from tests.unit.workflow_reading import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            PROBE,
            "qualified self-call",
            id="sweep-1-qualified-root-self-call-mixed-case",
        ),
        pytest.param(
