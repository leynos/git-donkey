...
def test_git_fafo_runs_expected_commands(
    ...
    """git-fafo should invoke copier, gh, and git with expected arguments."""
    ...
    assert calls[1] == "gh repo create example/demo-repo --public"
    assert "git init" in calls[2]
